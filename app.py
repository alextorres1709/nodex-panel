...
MIGRATIONS = [
    ...
    # updated_at — needed by sync engine to detect local changes and prevent remote overwrites
    ("users", "updated_at", "TIMESTAMP"),
    ("payments", "updated_at", "TIMESTAMP"),
    ("projects", "updated_at", "TIMESTAMP"),
    ("project_contacts", "updated_at", "TIMESTAMP"),
    ("companies", "updated_at", "TIMESTAMP"),
    ("company_contacts", "updated_at", "TIMESTAMP"),
    ("email_templates", "updated_at", "TIMESTAMP"),
    ("company_interactions", "updated_at", "TIMESTAMP"),
    ("tools", "updated_at", "TIMESTAMP"),
    ("ideas", "updated_at", "TIMESTAMP"),
    ("objectives", "updated_at", "TIMESTAMP"),
    ("incomes", "updated_at", "TIMESTAMP"),
    ("credentials", "updated_at", "TIMESTAMP"),
    ("clients", "updated_at", "TIMESTAMP"),
    ("notifications", "updated_at", "TIMESTAMP"),
    ("time_entries", "updated_at", "TIMESTAMP"),
    ("invoices", "updated_at", "TIMESTAMP"),
    ("subtasks", "updated_at", "TIMESTAMP"),
    ("documents", "updated_at", "TIMESTAMP"),
    ("automations", "updated_at", "TIMESTAMP"),
    ("project_templates", "updated_at", "TIMESTAMP"),
